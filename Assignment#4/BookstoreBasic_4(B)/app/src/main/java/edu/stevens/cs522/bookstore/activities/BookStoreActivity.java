...
import managers.IEntityCreator;
...
public class BookStoreActivity extends ListActivity
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        bookmgr = new BookManager(this, new IEntityCreator<Book>() {
            @Override
        ...
        loadermgr.initLoader(BOOK_LOADER_ID,null,this);
    ...
    public void calldelete()
    {
        ...
        loadermgr.restartLoader(BOOK_LOADER_ID,null,this);
    }
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        CartDbAdapter bd = new CartDbAdapter(this, cursor);
    ...
    public void onLoaderReset(Loader<Cursor> cursorLoader) {
        CartDbAdapter bd = new CartDbAdapter(this, null);
        bd.swapCursor(null);
    }
}