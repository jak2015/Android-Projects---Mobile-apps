...
public class RequestService extends IntentService {
	...
	protected void onHandleIntent(Intent intent) {
		...
		case 1:
			...
			Cursor cursor = cr.query(CloudProvider.CONTENT_URI, null,null, null, "message.messageid");
			int messageid = 0;
			...
			Cursor c = cr.query(CloudProvider.CONTENT_URI_PEER, null,"peer.name=?", new String[] { name }, null);
			Peer peer = new Peer();
			if (c.moveToFirst()) {
				do{
					peer = new Peer(c);
