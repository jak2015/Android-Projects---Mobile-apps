...
public class DbAdapter {
	public static final String DATABASE_NAME = "ChatCloud.s3db";
	public static final String DATABASE_MESSAGE_TABLE = "message";
	public static final String DATABASE_PEER_TABLE = "peer";
	...
	public DbAdapter open() throws SQLException {
		dbHelper = new DatabaseHelper(context, DATABASE_NAME, null, CloudProvider.DATABASE_VERSION);
	...
	public Cursor getAllPeer() {
		return db.query(DATABASE_PEER_TABLE, new String[] { ID, SENDERNAME, ADDRESS }, null, null, null, null, null);
	}
	...
	public String getNameById(long id){
		...
		Cursor c =  db.query(DATABASE_PEER_TABLE,
				new String[] { ID, SENDERNAME, ADDRESS }, whereClause, whereArgs,
				null, null, null);
		String name = null;
		if(c.moveToFirst()){
