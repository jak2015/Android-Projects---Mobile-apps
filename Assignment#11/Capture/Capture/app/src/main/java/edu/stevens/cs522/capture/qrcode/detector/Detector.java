...
package edu.stevens.cs522.capture.qrcode.detector;
...
import edu.stevens.cs522.capture.ResultPointCallback;
import edu.stevens.cs522.capture.qrcode.decoder.Version;
import edu.stevens.cs522.capture.util.BitMatrix;
import edu.stevens.cs522.capture.util.DetectorResult;
import edu.stevens.cs522.capture.util.GridSampler;
import edu.stevens.cs522.capture.util.PerspectiveTransform;
import edu.stevens.cs522.capture.util.detector.MathUtils;
